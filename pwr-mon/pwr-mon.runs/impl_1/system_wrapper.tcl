...
namespace eval ::optrace {
  variable script "F:/Dropbox/04_TU/02_SoC_Labor/Labor-SoC-Design/pwr-mon/pwr-mon.runs/impl_1/system_wrapper.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet F:/Dropbox/04_TU/02_SoC_Labor/Labor-SoC-Design/pwr-mon/pwr-mon.runs/synth_1/system_wrapper.dcp

...
proc cr_bd_system { parentCell } {
  ...
  set test_inp [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 test_inp ]
  ...
  connect_bd_intf_net [get_bd_intf_ports test_inp] [get_bd_intf_pins pwr_mon_0/ev_in]

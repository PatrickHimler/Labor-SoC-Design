...
proc create_root_design { parentCell } {
  ...
  # Create instance: pwr_mon_0, and set properties
  ...
  connect_bd_intf_net -intf_net pwr_mon_0_serial_tx [get_bd_intf_ports serial_tx] [get_bd_intf_pins pwr_mon_0/serial_tx]

  # Create port connections
  connect_bd_net -net AES_PROCESS_0_s_pwr_v [get_bd_pins AES_PROCESS_0/s_pwr_v] [get_bd_pins pwr_mon_0/ev_in]
  ...
  assign_bd_address -offset 0x43C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AES_PROCESS_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AMA142_OLED_AXI/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0x41210000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs BTN_GPIO_AXI/S_AXI/Reg] -force
  assign_bd_address -offset 0x41200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs SW_LED_GPIO_AXI/S_AXI/Reg] -force
